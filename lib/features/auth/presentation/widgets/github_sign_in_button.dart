...
class GitHubSignInButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final logoAsset = 'assets/auth/GitHub_Invertocat_Light.svg';
            ...
            children: [
              ...
              SizedBox(
                ...
                child: SvgPicture.asset(
                  ...
                  colorFilter: ColorFilter.mode(
                    isDark ? Colors.white : const Color(0xFF1B1F24),
                    BlendMode.srcIn,
                  ),
                ),
              ),
              Expanded(
                child: Text(
                  ...
                  style: TextStyle(fontFamily: 'MonaSansVar', fontSize: 16)
                      .copyWith(
                        color: textColor,
